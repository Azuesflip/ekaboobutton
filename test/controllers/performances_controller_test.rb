...
class PerformancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create performance" do
    assert_difference('Performance.count') do
      post performances_url, params: { performance: { body: @performance.body, date: @performance.date, location: @performance.location, title: @performance.title } }
    end
  ...
  test "should update performance" do
    patch performance_url(@performance), params: { performance: { body: @performance.body, date: @performance.date, location: @performance.location, title: @performance.title } }
